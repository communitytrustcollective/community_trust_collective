...
Reports may range from code-of-conduct concerns that led to community action, to more serious allegations. And in the case of even seemingly minor sexual harassment - such as unwanted sexual comments or  advances - it can be important to report, because multiple reports may reveal a pattern of behavior. Information in this system is provided for community safety purposes and does not constitute a finding of guilt or wrongdoing. A record should be treated as a reason for organizers to seek additional information and make their own informed decisions. Users are responsible for using and handling information in accordance with applicable laws and privacy requirements.''')
