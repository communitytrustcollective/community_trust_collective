...
st.text('')
st.markdown('''**:blue-background[highlightProblem -]** Individuals with a history of misconduct may move between communities to where organizers are unaware of their history. 
